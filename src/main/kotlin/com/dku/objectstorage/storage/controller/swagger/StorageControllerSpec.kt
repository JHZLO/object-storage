...
interface StorageControllerSpec {
    ...
    @Operation(
        ...
        description = """
        fileId로 파일을 다운로드(혹은 웹뷰에서 바로 볼 수 있도록)합니다.
        disposition이 attachment이면 다운로드, inline이면 브라우저에서 바로 열립니다.
        """
    )
    fun downloadFile(
        ...
        @Parameter(description = "attachment 또는 inline (기본값: inline)", required = false) disposition: String,
